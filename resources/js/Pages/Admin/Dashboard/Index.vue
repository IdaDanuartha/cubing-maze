                        ...
                        <div class="row d-block d-xl-flex align-items-center">
                            <div
                                ...
                                <div class="d-sm-none">
                                    ...
                                    <h3 class="fw-extrabold mb-1">{{ course_revenue }}</h3>
                                </div>
                            </div>
                        ...
                        <div class="row d-block d-xl-flex align-items-center">
                            <div
                                ...
                                <div class="d-sm-none">
                                    ...
                                    <h3 class="fw-extrabold mb-1">{{ cubers_count }}</h3>
                                </div>
                            </div>
                            <div class="col-12 col-xl-7 px-xl-0">
                                <div class="d-none d-sm-block">
                        ...
                        <div class="row d-block d-xl-flex align-items-center">
                            <div
                                ...
                                <div class="d-sm-none">
                                    ...
                                    <h3 class="fw-extrabold mb-1">{{ reports_count }}</h3>
                                </div>
                            </div>
                            <div class="col-12 col-xl-7 px-xl-0">
                                <div class="d-none d-sm-block">
                        ...
                        <div class="row d-block d-xl-flex align-items-center">
                            <div
                                ...
                                <div class="d-sm-none">
                                    ...
                                    <h3 class="fw-extrabold mb-1">{{ course_students_count }}</h3>
                                </div>
                            </div>
                            <div class="col-12 col-xl-7 px-xl-0">
                                <div class="d-none d-sm-block">
