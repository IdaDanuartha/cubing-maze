<template>
    ...
    <Head>
        ...
        <meta name="description" description="Halaman login untuk administrator cubingmaze">
        <meta name="keywords" description="login page cubingmaze, halaman login cubingmaze, login administrator">
    </Head>
